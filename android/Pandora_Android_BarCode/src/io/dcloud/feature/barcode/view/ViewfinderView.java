	...
	private void drawLaserLine(Canvas canvas, Rect detectorRect) {
		if (running) {
			if (laserBitmap == null) {
				...
				Shader Shader = new RadialGradient(detectorRect.width() / 2, DetectorViewConfig.LASER_WIDTH / 2, 240,DetectorViewConfig.laserColor, DetectorViewConfig.laserColor_,  TileMode.CLAMP); 
