...
- (void)drawInContext:(CGContextRef)context {
    CGColorRef whiteColor = [UIColor colorWithRed:1.0 green:0.0 blue:0.0 alpha:0.0].CGColor;
...
- (void)drawRect:(CGRect)rect {
    ...
    [self drawRect:CGRectMake(0, 0, self.bounds.size.width, paddingY)
         fillColor:kOverlayColor inContext:context];
    // left
    ...
    CGContextSetStrokeColor(context, kLineColor);
